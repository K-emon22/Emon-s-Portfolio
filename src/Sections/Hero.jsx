  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-0 w-full max-w-7xl">
        ...
        <Fade cascade damping={0.2} duration={500} triggerOnce={false}>
          <div className="flex flex-col gap-5">
            ...
            <Slide direction="up" duration={500} triggerOnce={false}>
              <h2 className="text-2xl md:text-3xl font-semibold text-gray-700 text-center md:text-start">
                MERN Stack Web Developer
              </h2>
            </Slide>

            <Fade delay={300} duration={500} triggerOnce={false}>
            ...
            <Zoom delay={400} duration={500} triggerOnce={false}>
              <div className="animate-border-glow flex flex-row gap-4 md:gap-1 lg:gap-4 mx-auto md:mx-0 border-4 rounded-full justify-center items-center w-4/5 sm:w-3/5 md:w-3/5 lg:h-4/5 xl:w-2/5 p-1">
                <a
                  ...
                  className="w-16 h-16 flex justify-center items-center border-2 rounded-full border-blue-400 hover:bg-blue-50 transition-transform hover:scale-105 duration-300"
                >
            ...
            <Fade delay={500} duration={500} triggerOnce={false}>
